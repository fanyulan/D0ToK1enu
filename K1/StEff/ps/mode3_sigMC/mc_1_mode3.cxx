...
for (int nmode=3; nmode<4; nmode++) {
    ...
    TFile *f = TFile::Open("root/et1_dh3_data.root");
...
*/
  ...
  //plot on 
    ...
    rp1->SetMarkerSize(0.5);
     ...
     lt1.DrawLatex(0.22, 0.76,  "#chi^{2}_{ndof} = 2.8");
    ...
    /************************************************end********************************************************/
    ofstream fit_data;
    fit_data.open(Form("./figure/mode3/mc_1_%d_data.dat",nmode), ios::app);
    ...
    */
     ...
     cvs->Print(Form("figure/mode3/mc_1_%d_data.eps",nmode),"recreate");    
     cout<<"chi2 "<<chi2<<endl;
     cout<<"eff "<<eff<<endl;
     }
}
