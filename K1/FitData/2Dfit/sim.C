...
TCut m3 = "mode==3&&deltaE>-0.031&&deltaE<0.028";
    ...
    double smooth = 0.5, nSigma = 2;
    double smooth_k3pi = 0.6;
   //mode0
    TChain* ch_sig0 = new TChain("sig");
    ch_sig0->Add("dat/sig_0.root");
    ...
    ch_bkg0->Add("dat/offical_bkg_0.root");
    RooDataSet *bkgshape0 = new RooDataSet("bkgshape0", "bkgshape0", ch_bkg0, m_u);
    RooNDKeysPdf pbkg0("pbkg0","",m_u,*bkgshape0, "am",smooth,nSigma);
    
    TChain* ch_bkg0_k3pi = new TChain("bkg");
    ch_bkg0_k3pi->Add("dat/k3pi_bkg_0.root");
    ...
    ch_bkg1->Add("dat/offical_bkg_1.root");
    RooDataSet *bkgshape1 = new RooDataSet("bkgshape1", "bkgshape1", ch_bkg1, m_u);
    RooNDKeysPdf pbkg1("pbkg1","",m_u,*bkgshape1, "am",smooth,nSigma);
    
    TChain* ch_bkg1_k3pi = new TChain("bkg");
    ch_bkg1_k3pi->Add("dat/k3pi_bkg_1.root");
    ...
    ch_bkg3->Add("dat/offical_bkg_2.root");
    RooDataSet *bkgshape3 = new RooDataSet("bkgshape3", "bkgshape3", ch_bkg3, m_u);
    RooNDKeysPdf pbkg3("pbkg3","",m_u,*bkgshape3, "am",smooth,nSigma);
    
    TChain* ch_bkg3_k3pi = new TChain("bkg");
    ch_bkg3_k3pi->Add("dat/k3pi_bkg_2.root");
  ...
  ntag>>Ntag[0]>>Ntag[1]>>Ntag[2];
    ...
    RooRealVar nbkg0("nbkg0", "", 10,1,50); //nbkg.setConstant(1);
    RooRealVar nbkg1("nbkg1", "", 30,1,100); //nbkg.setConstant(1);
    RooRealVar nbkg3("nbkg3", "", 30,1,100); //nbkg.setConstant(1);
    
    RooRealVar nbkg0_k3pi("nbkg0_k3pi", "", 3.60);//2.72 
    RooRealVar nbkg1_k3pi("nbkg1_k3pi", "", 7.70);//6.51
    RooRealVar nbkg3_k3pi("nbkg3_k3pi", "", 8.76);//4.13 
...
///////////////////////////////////////////////////////////////////modes///////////////////
    ...
    hmhadall->SetXTitle("M(K#pi#pi) [GeV]");
     ...
     c1->Print("figure/ps_data2D_modes.eps");
    cv2->Print("figure/ps_data2D.eps");
    ofstream out;
    out.open("figure/ps_data2D.dat");
    ...
    out<<"total fit    : "<<Nsig0+Nsig1+Nsig3<<"+/-"<<Nsig1_err*(Nsig0+Nsig1+Nsig3)/Nsig1;
     ...
     out_1<<"fit to data(after correct the eff): "<<setprecision(9)<<bf_K1<<"\t"<<bf_K1_err<<"\t"<<"\n";
