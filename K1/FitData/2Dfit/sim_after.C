...
TCut m3 = "mode==3&&deltaE>-0.031&&deltaE<0.028";
  ...
  double eff[4];
  for(int i=0;i<4;i++){
  ifstream dat("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/script/CWR_VSS/update/eff/dat/correction.dat");
...
///////////////////////////////////////////////////////////////////modes///////////////////
    ...
    hmhadall->SetXTitle("M(K#pi#pi) [GeV]");
     ...
     c1->Print("figure/CWR_after_modes.eps");
    cv2->Print("figure/CWR_after.eps");
    ofstream out;
    out.open("figure/CWR_after.dat");
