   ...
   gStyle->SetTitle("");
    gStyle->SetOptStat(0);
     gStyle->SetEndErrorSize(0);
      ...
      int bins = 100;
      hsig_1        = new TH1F("hsig_1","", bins,-0.1,0.1);
      hbkg_1        = new TH1F("hbkg_1","", bins,-0.1,0.1);
      hdata_1       = new TH1F("hdata_1","",bins,-0.1,0.1);
       
      tdata.Draw("Umissfit>>hdata_1", (cut0||cut1||cut3)&&cuta&&cutb&&cutc);
      tsig.Draw( "Umissfit>>hsig_1",  (cut0||cut1||cut3)&&cuta&&cutb&&cutc&&cut_signal);  
      tbkg.Draw( "Umissfit>>hbkg_1",  (cut0||cut1||cut3)&&cuta&&cutb&&cutc&&!cut_signal&&!cut_K2);
     ...
     hbkg_1->GetXaxis()->SetTitle("M_{miss}^{2} GeV^{2}/c^{4}");
     hbkg_1->GetYaxis()->SetTitle("Events(/0.002 GeV^{2}/c^{4})");
     ...
     hbkg_1->GetYaxis()->SetRangeUser(0,1.55*hdata_1->GetMaximum());
      ...
      leg = new TLegend(0.2,0.70,0.71,0.89);
      leg->SetBorderSize(0);
      leg->SetTextFont(22);
      leg->SetLineColor(0);
      leg->SetFillColor(0);
