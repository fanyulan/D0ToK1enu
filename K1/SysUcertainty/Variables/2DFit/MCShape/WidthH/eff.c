...
void eff()
{
  ...
  TChain t1("truth");
  t1.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/width_high/root/D0_*.root");
  TChain t2("truth");
  t2.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/width_high/root/D0bar_*.root");
