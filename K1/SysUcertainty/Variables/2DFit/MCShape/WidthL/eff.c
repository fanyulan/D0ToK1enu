...
void eff()
{
  ...
  //cut
  TChain t0("tagD");
  t0.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/width_high/red_truth/truth.root");
  ...
  TChain t1("truth");
  t1.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/width_low/root/D0_*.root");
  t1.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/width_low/root/KsKpi_D0.root");
  TChain t2("truth");
  t2.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/width_low/root/D0bar_*.root");
  t2.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/width_low/root/KsKpi_D0bar.root");
...
*/double ST0_eff = 0.66089, ST1_eff = 0.349938, ST3_eff = 0.4107;
