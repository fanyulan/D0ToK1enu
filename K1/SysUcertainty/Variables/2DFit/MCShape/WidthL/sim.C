...
TCut m3 = "mode==3&&deltaE>-0.031&&deltaE<0.028";
    ...
    double smooth_k3pi = 0.8, smooth_bkg = 0.9;
   //mode0
    TChain* ch_sig0 = new TChain("sig");
    ch_sig0->Add("pdf/sig_0.root");
...
///////////////////////////////////////////////////////////////////modes///////////////////
    ...
    hmhadall->SetXTitle("M(K#pi#pi) [GeV]");
     ...
     c1->Print("figure/wl_modes.eps");
    cv2->Print("figure/wl.eps");
    ofstream out;
    out.open("figure/wl.dat");
