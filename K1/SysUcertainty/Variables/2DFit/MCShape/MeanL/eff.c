...
void eff()
{
  ...
  //cut
  TChain t0("tagD");
  t0.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/mean_low/red_truth/truth.root");
  ...
  TChain t1("truth");
  t1.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/mean_low/root/D0_*.root");
  t1.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/mean_low/root/KsKpi_D0.root");
  TChain t2("truth");
  t2.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/mean_low/root/D0bar_*.root");
  t2.Add("/besfs/groups/psipp/psippgroup/public/fangyl/cocktail/sigMC/update/mc_shape/mean_low/root/KsKpi_D0bar.root");
