...
void ePID_plus()
{
   ...
   TCut cut_p[19]={"p<0.2","p>=0.2&&p<0.3","p>=0.3&&p<0.4","p>=0.4&&p<0.5","p>=0.5&&p<0.6","p>=0.6&&p<0.7","p>=0.7&&p<0.8","p>=0.8&&p<0.9","p>=0.9&&p<1.0","p>=1.0&&p<1.1","p>=1.1&&p<1.2","p>=1.2&&p<1.3","p>=1.3&&p<1.4","p>=1.4&&p<1.5","p>=1.5&&p<1.6","p>=1.6&&p<1.7","p>=1.7&&p<1.8","p>=1.8&&p<1.9","p>=1.9&&p<2.0"}; 
