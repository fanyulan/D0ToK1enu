...
void draw()
{
    ...
    ifstream openfile;
    openfile.open("./dat/minus_delta_eff.txt");
    //openfile.open("./dat/plus_delta_eff1.txt");
    ...
    dt1->Draw("surf1");    
    resf1->Print("./figure/minus_eff_data1.eps");
    //resf1->Print("./figure/plus_eff_data1.eps");
     ...
     dt2->Draw("surf1");  
     resf2->Print("./figure/minus_eff_mc1.eps");
     ...
     dt3->Draw("surf1");    
     resf3->Print("./figure/minus_delta1.eps");
     //resf3->Print("./figure/plus_delta.eps");
     ...
     dt4->Draw("surf1");    
     resf4->Print("./figure/minus_diff1.eps");
