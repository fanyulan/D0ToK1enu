...
for(int nvar=0; nvar<8; nvar++) {

    TCut cut_sig = "isTrueTag==1&&isSignal==1&&abs(KpTrueID)==321&&abs(pi1TrueID)==211&&abs(pi2TrueID)==211&&abs(elecTrueID)==11&&abs(elecMomID)==421";
    ...
    TCanvas *c = new TCanvas("c", "Umissfit_bkg",0,0, 800,600);
...
///////////////////////////////////after/////////////////////////////////
    if(nvar==7) {
        t.Draw("Umissfit>>sig",       (cut0||cut1||cut3)&&cuta&&cutc&&cut_sig&&cut_K1&&cut_deltaE_pipzswp);
        t.Draw("Umissfit>>kpipipi",   (cut0||cut1||cut3)&&cuta&&cutc&&!(cut_sig&&cut_K1)&&!cut_K2&&(cut_103||cut_1032)&&cut_deltaE_pipzswp);
        t.Draw("Umissfit>>kpipipipi0",(cut0||cut1||cut3)&&cuta&&cutc&&!(cut_sig&&cut_K1)&&!cut_K2&&(cut_105||cut_455)&&cut_deltaE_pipzswp);
        t.Draw("Umissfit>>kpienu",    (cut0||cut1||cut3)&&cuta&&cutc&&!(cut_sig&&cut_K1)&&!cut_K2&&cut_715&&cut_deltaE_pipzswp);
        t.Draw("Umissfit>>kpi0enu",   (cut0||cut1||cut3)&&cuta&&cutc&&!(cut_sig&&cut_K1)&&!cut_K2&&cut_201&&cut_deltaE_pipzswp);
        t.Draw("Umissfit>>kpipi0pi0", (cut0||cut1||cut3)&&cuta&&cutc&&!(cut_sig&&cut_K1)&&!cut_K2&&cut_104&&cut_deltaE_pipzswp);
        t.Draw("Umissfit>>kpipi0",    (cut0||cut1||cut3)&&cuta&&cutc&&!(cut_sig&&cut_K1)&&!cut_K2&&cut_102&&cut_deltaE_pipzswp);
        t.Draw("Umissfit>>other",     (cut0||cut1||cut3)&&cuta&&cutc&&!(cut_sig&&cut_K1)&&!cut_K2&&cut_deltaE_pipzswp&&!(cut_455||cut_103||cut_105||cut_715||cut_201||cut_104||cut_1032||cut_102));  }
        
        //t.Draw("Umissfit>>sig",       (cut0||cut1||cut3)&&cuta&&cutc&&cut_sig&&cut_K1&&cut_deltaE_pipzswp);
        //t.Draw("Umissfit>>kpipipi",   (cut0||cut1||cut3)&&cuta&&cutc&&!cut_K2&&(cut_103||cut_1032)&&cut_deltaE_pipzswp);
        //t.Draw("Umissfit>>kpipipipi0",(cut0||cut1||cut3)&&cuta&&cutc&&!cut_K2&&(cut_105||cut_455)&&cut_deltaE_pipzswp);
        //t.Draw("Umissfit>>kpienu",    (cut0||cut1||cut3)&&cuta&&cutc&&!cut_K2&&cut_715&&cut_deltaE_pipzswp);
        //t.Draw("Umissfit>>kpi0enu",   (cut0||cut1||cut3)&&cuta&&cutc&&!cut_K2&&cut_201&&cut_deltaE_pipzswp);
        //t.Draw("Umissfit>>kpipi0pi0", (cut0||cut1||cut3)&&cuta&&cutc&&!cut_K2&&cut_104&&cut_deltaE_pipzswp);
        //t.Draw("Umissfit>>kpipi0",    (cut0||cut1||cut3)&&cuta&&cutc&&!cut_K2&&cut_102&&cut_deltaE_pipzswp);
        //t.Draw("Umissfit>>other",     (cut0||cut1||cut3)&&cuta&&cutc&&!cut_K2&&cut_deltaE_pipzswp&&!(cut_455||cut_103||cut_105||cut_715||cut_201||cut_104||cut_1032||cut_102));  }
...
///////////////////////////////////after/////////////////////////////////
    ...
    PLabel1X->SetHeader("M_{miss}^{2} (GeV^{2}/#font[12]{c}^{4})");
    PLabel1X->Draw();
    ...
    PLabel1Y->SetHeader("Events / (0.0025 GeV^{2}/#font[12]{c}^{4})");
    PLabel1Y->Draw();
    ...
    c->cd();
    c->SetSelected(c);
    c->Print(Form("./figure/stack_bkg_%d.eps",nvar));
}
}
